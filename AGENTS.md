...
- **No `Codex` / `AI` generation markers in commit messages.** No `Co-Authored-By: Codex*`, no
  `Generated with Codex` footer. A message describes the change and nothing else.
